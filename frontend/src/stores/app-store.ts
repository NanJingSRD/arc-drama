...
interface AppState {
  ...
  /** 全屏阻塞 loading 文案；非 null 时 BlockingOverlay 显示并锁定 body 滚动 */
  blockingOverlay: string | null;
  setBlockingOverlay: (message: string | null) => void;
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  setBlockingOverlay: (message) => set({ blockingOverlay: message }),
