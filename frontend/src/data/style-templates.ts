...
export const STYLE_TEMPLATES_RAW: StyleTemplate[] = [
  // ===== 真人 (18) =====
...
export const STYLE_TEMPLATES: StyleTemplate[] = STYLE_TEMPLATES_RAW.map((t) => ({
  ...t,
  thumbnail: publicAssetUrl(t.thumbnail.replace(/^\//, "")),
}));
