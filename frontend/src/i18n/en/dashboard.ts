...
export default {
  ...
  'welcome_idle_line': 'Welcome to {{title}}! Drag or upload your novel source files — AI will parse the lore for you.',
  ...
  'welcome_next_steps_tip': 'AI will analyze your novel and extract characters, scenes, props, and world settings; then generate a project overview so you can start creating scripts and storyboards',
  'extracting_asset_type': 'Extracting {{type}}…',
  ...
  'no_reference_image': 'No reference image yet',
  'character_design': 'Character Design',
  'scene_design': 'Scene Design',
  'prop_design': 'Prop Design',
  // Workspace v2 only (legacy Studio keeps *design* copy above)
  'ws2_character_asset_image': 'Character Asset',
  'ws2_scene_asset_image': 'Scene Asset',
  'ws2_prop_asset_image': 'Prop Asset',
  'ws2_generate_asset_image': 'Generate Asset',
  'ws2_regenerate_asset_image': 'Regenerate Asset',
  'ws2_novel_original_text': 'Original Novel Text',
  'ws2_view_full_original_text': 'View full text',
  'ws2_asset_status_draft': 'Pending generation',
  'ws2_asset_status_failed': 'Generation failed',
  'ws2_asset_prompt_template': 'Prompt Template',
  'ws2_asset_prompt_template_placeholder': 'Edit the asset image prompt template (Layout / Guard / Negative)',
  'ws2_asset_prompt_template_layout': 'Layout',
  'ws2_asset_prompt_template_guard': 'Guard',
  'ws2_asset_prompt_template_negative_tail': 'Negative',
  'ws2_generating_asset_type': 'Generating all {{type}}…',
  'no_prompt_template': 'No prompt template',
  ...
  'asset_card_menu_aria': '打开{{name}}生成菜单',
  'asset_card_open_detail_aria': 'View {{name}} details',
  'asset_detail_empty_voice_style': 'No voice style yet',
  'asset_card_generate': 'Generate',
  'asset_card_regenerate': 'Regenerate',
  'characters_count': 'Characters ({{count}})',
  'scenes': 'Scenes',
  'props': 'Props',
  'no_characters_hint': 'No characters yet, click the button below to add.',
  'no_characters_hint_clickable': 'No characters yet',
  'no_scenes_hint_clickable': 'No scenes yet',
  'no_props_hint_clickable': 'No props yet',
  'products': 'Products',
  'product_design': 'Product Reference Sheet',
  'product_desc_placeholder': 'Enter product description...',
  'no_products_hint_clickable': 'No products yet',
  ...
  'export_merged_video': 'Export Merged Video',
  'export_merged_video_hint': 'Merge all video clips into a single complete video',
  'export_video': 'Export Video',
  'merged_video_export_started': 'Merged video export started',
  ...
  'storyboard_batch_submitted_toast': 'Submitted {{count}} storyboard generation tasks',
  'storyboard_batch_none_missing_toast': 'All storyboards already generated',
  'storyboard_upload_submitted_toast': 'Storyboard upload task for "{{id}}" submitted',
  'storyboard_upload_batch_submitted_toast': 'Submitted {{count}} storyboard upload tasks',
  'storyboard_upload_loading': 'Authorizing storyboard "{{id}}"…',
  'storyboard_upload_batch_loading': 'Batch authorizing {{count}} storyboards…',
  'storyboard_upload_batch_loading_hint': 'Authorizing synchronously — storyboard status will refresh when done…',
  'upload_storyboard_failed': 'Storyboard upload failed: {{message}}',
  'video_batch_submitted_toast': 'Submitted {{count}} video generation tasks',
  'video_batch_none_missing_toast': 'All videos already generated',
  ...
  'task_hud_title': 'Task List',
  'task_radar_meter_ok': 'Done',
  'task_radar_meter_fail': 'Fail',
  'task_radar_empty_hint': 'No channel echoes yet',
  ...
  'direct_generate_episode': 'Generate Episode',
  'direct_generating': 'Generating…',
  'direct_generate_success': 'Episode "{{title}}" generated successfully',
  'generate_assets': 'Generate {{type}}',
  'generating_assets': 'Generating…',
  'auto_generate_assets_success': 'Successfully generated {{count}} {{type}}',
  'select_episode_for_generation': 'Select Episode',
  'all_episodes': 'All Episodes',
  'episode_label': 'Episode {{episode}}',
  'generate_for_episode': 'Generate for Episode {{episode}}',
  'generate_for_all': 'Generate for All Episodes',
  'curl_dialog_storyboard_title': 'Storyboard Generation Info',
  'curl_dialog_video_title': 'Video Generation Info',
  'curl_dialog_curl_command': 'Curl Command',
  'curl_dialog_image_prompt': 'Image Prompt',
  'curl_dialog_video_prompt': 'Video Prompt',
  'curl_dialog_show_info': 'View Generation Request Info',
  'generate_all': 'Generate All',
  'generate_all_started': 'Started generating all {{type}}',
  ...
  'storyboard_upload_task_failed': 'Storyboard "{{id}}" upload failed: {{reason}}',
  ...
  'discovery_format_google': 'Google Compatible',
  'discovery_format_custom': 'Custom API',
  ...
  'endpoint_token_platform_image_display': 'Token Platform (Image)',
  'endpoint_token_platform_video_display': 'Token Platform (Video)',
  ...
  'source_upload_success_toast': '"{{filename}}" uploaded successfully',
  ...
  'batch_upload_storyboards': 'Batch authorize storyboards',
  'upload_storyboard': 'Authorize storyboard',
  'upload_storyboard_already_authorized': 'This storyboard is already authorized',
  'storyboard_authorized': 'Authorized',
  'upload_storyboard_confirm_title': 'Confirm storyboard upload',
  'batch_upload_storyboards_confirm_title': 'Confirm batch storyboard upload',
  'upload_storyboards_confirm_description': 'Uploading storyboards requires authorization to access the external platform. Continue?',
  'upload_storyboards_confirm': 'Authorize & upload',
  ...
  'media_generate_video_unauthorized_hint': 'Authorize the storyboard first',
  ...
  'workspace_generate_script': 'Generate script',
  'workspace_regenerate_script': 'Regenerate script',
  'workspace_regenerate_script_confirm_title': 'Regenerate script',
  'workspace_regenerate_script_confirm_desc': 'This will regenerate all episode scripts. Existing episodes may be overwritten. Continue?',
  'workspace_generate_all_storyboards': 'Generate all storyboards',
  'workspace_generate_storyboard': 'Generate storyboard config',
  'workspace_storyboard_config_required_title': 'Storyboard config not ready',
  'workspace_storyboard_config_required_hint': 'Click “Generate storyboard config” below to unlock episodes and shot editing',
  'workspace_workflow_complete_eyebrow': 'Workflow Complete',
  'workspace_workflow_complete_title': 'Workflow complete',
  'workspace_workflow_complete_desc': 'Every stage from plot import to storyboard production is done. You can revisit any step anytime.',
  'workspace_add_shot': 'Add shot',
  'workspace_add_shot_title': 'Add shot',
  'workspace_add_shot_index_label': 'Shot index',
  'workspace_add_shot_index_hint': 'Insert position: 0 = start, 1 = after the first shot',
  'workspace_add_shot_duration_label': 'Duration (seconds)',
  'workspace_add_shot_duration_hint': 'Maps to duration_seconds; default 8s',
  'workspace_add_shot_duration_invalid': 'Enter a valid positive integer duration in seconds',
  'workspace_add_shot_text_label': 'Shot text',
  'workspace_add_shot_text_placeholder': 'Enter the shot source text…',
  'workspace_add_shot_submit': 'Add',
  'workspace_add_shot_success': 'Shot added',
  'workspace_add_shot_pipeline_title': 'Adding shot…',
  'workspace_add_shot_step_content': 'Processing shot content',
  'workspace_add_shot_step_content_hint': 'Parsing shot text and writing the scene. Please wait…',
  'workspace_add_shot_step_config': 'Generating storyboard config',
  'workspace_add_shot_step_config_hint': 'Shot content is ready. Generating image/video prompts…',
  'workspace_add_shot_pipeline_ready': 'Shot is ready',
  'workspace_add_shot_content_failed': 'Shot content processing failed: {{message}}',
  'workspace_add_shot_configuring': 'Updating config…',
  'workspace_add_shot_config_ready': 'Shot config updated',
  'workspace_add_shot_config_failed': 'Failed to update shot config: {{message}}',
  'workspace_add_shot_failed': 'Failed to add shot: {{message}}',
  'workspace_add_shot_index_invalid': 'Enter a valid non-negative integer index',
  'workspace_add_shot_text_required': 'Shot text is required',
  'workspace_add_episode': 'Add episode',
  'workspace_episode_list_title': 'Episode list',
  'workspace_add_episode_title': 'Add episode',
  'workspace_add_episode_index_label': 'Episode index',
  'workspace_add_episode_index_hint': 'Insert position (1-based)',
  'workspace_add_episode_content_label': 'Episode content',
  'workspace_add_episode_mode_label': 'Content mode',
  'workspace_add_episode_mode_text': 'Plain text',
  'workspace_add_episode_mode_file': 'Upload file',
  'workspace_add_episode_text_placeholder': 'Enter episode text…',
  'workspace_add_episode_text_required': 'Episode text is required',
  'workspace_add_episode_file_label': 'Episode file',
  'workspace_add_episode_file_hint': 'Upload the episode text file; it will be uploaded before insert',
  'workspace_add_episode_file_placeholder': 'Click or drop a file here',
  'workspace_add_episode_file_selected': 'Selected: {{name}}',
  'workspace_add_episode_submit': 'Add',
  'workspace_add_episode_success': 'Episode added',
  'workspace_add_episode_processing': 'Processing episode…',
  'workspace_add_episode_processing_hint':
    'Episode content is being generated. This view will refresh automatically when ready.',
  'workspace_add_episode_pipeline_title': 'Preparing new episode…',
  'workspace_add_episode_step_script': 'Processing episode content',
  'workspace_add_episode_step_script_hint': 'Parsing and writing this episode script. Please wait…',
  'workspace_add_episode_step_config': 'Generating storyboard config',
  'workspace_add_episode_step_config_hint':
    'Script is ready. Generating image/video prompts for this episode…',
  'workspace_add_episode_ready': 'New episode is ready',
  'workspace_add_episode_failed': 'Failed to add episode: {{message}}',
  'workspace_add_episode_process_failed': 'Episode processing failed: {{message}}',
  'workspace_add_episode_index_invalid': 'Enter a valid positive integer index',
  'workspace_add_episode_file_required': 'Please upload an episode file',
  'workspace_delete_episode': 'Delete episode',
  'workspace_delete_episode_confirm_title': 'Delete episode?',
  'workspace_delete_episode_confirm_desc':
    'Delete "{{name}}"? This cannot be undone. Later episode numbers will be adjusted automatically.',
  'workspace_delete_episode_confirm': 'Delete',
  'workspace_delete_episode_success': 'Episode deleted',
  'workspace_delete_episode_failed': 'Failed to delete episode: {{message}}',
  'workspace_delete_shot': 'Delete shot',
  'workspace_delete_shot_confirm_title': 'Delete shot?',
  'workspace_delete_shot_confirm_desc': 'Delete shot "{{id}}"? This cannot be undone.',
  'workspace_delete_shot_confirm': 'Delete',
  'workspace_delete_shot_success': 'Shot deleted',
  'workspace_delete_shot_failed': 'Failed to delete shot: {{message}}',
  'workspace_regenerate_storyboard': 'Regenerate storyboard',
  'workspace_regenerate_storyboard_confirm_title': 'Regenerate storyboard',
  'workspace_regenerate_storyboard_confirm_desc':
    'This will regenerate storyboard config for this episode. Existing shots may be overwritten. Continue?',
  'workspace_generating_storyboards': 'Generating storyboards...',
  'workspace_storyboards_queued': 'Storyboard task queued',
  'workspace_storyboards_ready_toast': 'Storyboard config generated',
  'workspace_storyboards_failed': 'Storyboard generation failed: {{message}}',
  'workspace_storyboards_generating_hint': 'Generating storyboard and video prompts for each episode. Please wait…',
  'workspace_storyboard_episode_generating_hint': 'Generating storyboard config for this episode…',
  'workspace_storyboard_config_loading': 'Loading storyboard…',
  'workspace_storyboard_config_loading_hint': 'Fetching storyboard details for this episode…',
  'workspace_generating_script': 'Generating...',
  'workspace_script_queued': 'Queued...',
  'workspace_script_queued_hint': 'Script generation is queued. Please wait — episodes will refresh automatically when ready.',
  'workspace_script_fetching': 'Loading data...',
  'workspace_script_fetching_hint': 'Loading episode list, please wait…',
  'workspace_script_ready_toast': 'Script generation complete',
  'workspace_asset_extract_queued': 'Asset extraction queued. The list will refresh when ready.',
  'workspace_asset_extract_reused_task': 'Could not queue a new "{{label}}" extraction: the server returned an existing task instead of a new one.',
  'workspace_asset_extract_ready_toast': 'Asset extraction complete',
  'workspace_asset_extract_failed': 'Asset extraction failed: {{message}}',
  'workspace_asset_extract_failed_fallback': 'Unknown error',
  'workspace_script_episodes_empty_title': 'No episodes yet',
  'workspace_script_episodes_empty_hint': 'Click "Generate script" above to create episodes',
  'workspace_script_content_label': 'Script',
  'workspace_script_process_failed': 'Failed to generate script: {{message}}',
  'workspace_no_source_for_script': 'No novel source file found. Upload a source file first.',
  'workspace_empty_source_for_script': 'Source file is empty. Please upload again.',
  'workspace_script_empty_result': 'No script content returned',
  'workspace_script_episodes_label': 'Script episodes',
  'workspace_script_episode_name_column': 'Episode',
  'workspace_script_episode_characters_column': 'Characters',
  'workspace_script_episode_content_column': 'Content',
  'workspace_script_episode_created_at_column': 'Created',
  'workspace_script_episode_status_column': 'Status',
  'workspace_script_episode_updated_at_column': 'Updated',
  'workspace_script_episode_total_scenes_column': 'Scenes',
  'workspace_script_episode_duration_column': 'Est. duration',
  'workspace_script_episode_status_draft': 'Draft',
  'workspace_script_episode_detail_title': '{{name}} · Scene details',
  'workspace_script_episode_scene_count': '{{count}} scenes',
  'workspace_script_episode_empty_preview': 'No content',
  'workspace_script_scene_visual': 'Visual',
  'workspace_script_scene_action': 'Action',
  'workspace_script_scene_narration': 'Narration',
  'workspace_script_scene_dialogue': 'Dialogue',
