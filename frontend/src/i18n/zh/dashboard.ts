...
export default {
  ...
  'welcome_idle_line': '欢迎来到 {{title}}！请拖拽或上传您的小说源文件，AI 将为您拆解设定。',
  ...
  'welcome_next_steps_tip': 'AI 将分析您的小说，提取角色、场景、道具和世界观设定；自动生成项目概述，然后您可以开始创建剧本和分镜',
  'extracting_asset_type': '正在提取{{type}}…',
  ...
  'per_episode': '分集统计',
  'no_description': '暂无描述',
  'no_reference_image': '暂无参考图',
  'character_design': '角色设计图',
  'scene_design': '场景设计图',
  'prop_design': '道具设计图',
  // 工作空间 2.0 专用（老 Studio 仍用上面的 *design* 文案）
  'ws2_character_asset_image': '角色资产图',
  'ws2_scene_asset_image': '场景资产图',
  'ws2_prop_asset_image': '道具资产图',
  'ws2_generate_asset_image': '生成资产图',
  'ws2_regenerate_asset_image': '重新生成资产图',
  'ws2_novel_original_text': '小说原文',
  'ws2_view_full_original_text': '查看全文',
  'ws2_asset_status_draft': '待生成',
  'ws2_asset_status_failed': '生成失败',
  'ws2_asset_prompt_template': '提示词模版',
  'ws2_asset_prompt_template_placeholder': '可编辑资产图生成提示词模版（布局 / 约束 / 负面词）',
  'ws2_asset_prompt_template_layout': '布局',
  'ws2_asset_prompt_template_guard': '约束',
  'ws2_asset_prompt_template_negative_tail': '负面词',
  'ws2_generating_asset_type': '正在生成全部{{type}}…',
  'no_prompt_template': '暂无提示词模版',
  'reference_image': '参考图',
  ...
  'asset_card_generate': '生成',
  'asset_card_regenerate': '重新生成',
  'asset_card_menu_aria': '打开{{name}}生成菜单',
  'asset_card_open_detail_aria': '查看{{name}}详情',
  'asset_detail_empty_voice_style': '暂无声音风格',
  'characters_count': '角色 ({{count}})',
  'scenes': '场景',
  'props': '道具',
  'no_characters_hint': '暂无角色，点击下方按钮添加',
  'no_characters_hint_clickable': '暂无角色',
  'no_scenes_hint_clickable': '暂无场景',
  'no_props_hint_clickable': '暂无道具',
  'products': '产品',
  'product_design': '产品参考图',
  'product_desc_placeholder': '输入产品描述...',
  'no_products_hint_clickable': '暂无产品',
  ...
  'export_merged_video': '导出合成视频',
  'export_merged_video_hint': '将所有视频片段合并为一个完整视频',
  'export_video': '导出视频',
  'merged_video_export_started': '视频合成导出已开始',
  'select_episode': '选择集数',
  ...
  'storyboard_batch_submitted_toast': '已提交 {{count}} 个分镜图生成任务',
  'storyboard_batch_none_missing_toast': '所有分镜图均已生成',
  'storyboard_upload_submitted_toast': '已提交分镜 "{{id}}" 上传任务',
  'storyboard_upload_batch_submitted_toast': '已提交 {{count}} 个分镜上传任务',
  'storyboard_upload_loading': '正在授权分镜 "{{id}}"...',
  'storyboard_upload_batch_loading': '正在批量授权分镜（{{count}} 个）...',
  'storyboard_upload_batch_loading_hint': '同步授权中，完成后将自动刷新分镜状态…',
  'upload_storyboard_failed': '上传分镜失败: {{message}}',
  'video_batch_submitted_toast': '已提交 {{count}} 个视频生成任务',
  'video_batch_none_missing_toast': '所有视频均已生成',
  ...
  'task_hud_title': '任务列表',
  'task_radar_meter_ok': '成功',
  'task_radar_meter_fail': '失败',
  'task_radar_empty_hint': '暂无通道回波',
  ...
  'direct_generate_episode': '直接生成剧集',
  'direct_generating': '生成中…',
  'direct_generate_success': '剧集「{{title}}」生成成功',
  'generate_assets': '生成{{type}}',
  'generating_assets': '生成中…',
  'auto_generate_assets_success': '成功生成 {{count}} 个{{type}}',
  'select_episode_for_generation': '选择分集',
  'all_episodes': '全部剧集',
  'episode_label': '第{{episode}}集',
  'generate_for_episode': '为第{{episode}}集生成',
  'generate_for_all': '为全部剧集生成',
  'curl_dialog_storyboard_title': '分镜图生成信息',
  'curl_dialog_video_title': '视频生成信息',
  'curl_dialog_curl_command': 'Curl 命令',
  'curl_dialog_image_prompt': '图片提示词',
  'curl_dialog_video_prompt': '视频提示词',
  'curl_dialog_show_info': '查看生成请求信息',
  'generate_all': '生成全部',
  'generate_all_started': '已开始生成全部{{type}}',
  ...
  'storyboard_upload_task_failed': '分镜 "{{id}}" 上传失败：{{reason}}',
  ...
  'discovery_format_google': 'Google 兼容',
  'discovery_format_custom': '自定义 API',
  'endpoint_label': '调用端点',
  ...
  'endpoint_token_platform_image_display': 'Token 平台（图片）',
  'endpoint_token_platform_video_display': 'Token 平台（视频）',
  ...
  'source_upload_success_toast': '上传成功「{{filename}}」',
  ...
  'batch_upload_storyboards': '批量授权分镜',
  'upload_storyboard': '授权分镜',
  'upload_storyboard_already_authorized': '该分镜已授权，无需重复操作',
  'storyboard_authorized': '已授权',
  'upload_storyboard_confirm_title': '确认上传分镜',
  'batch_upload_storyboards_confirm_title': '确认批量上传分镜',
  'upload_storyboards_confirm_description': '上传分镜需要授权访问外部平台，确认继续？',
  'upload_storyboards_confirm': '确认授权',
  ...
  'media_generate_video_unauthorized_hint': '请先授权分镜',
  ...
  'workspace_generate_script': '生成剧本',
  'workspace_regenerate_script': '重新生成剧本',
  'workspace_regenerate_script_confirm_title': '重新生成剧本',
  'workspace_regenerate_script_confirm_desc': '将重新生成全部分集剧本，现有分集内容可能会被覆盖。确定继续？',
  'workspace_generate_all_storyboards': '生成全部分镜',
  'workspace_generate_storyboard': '生成分镜配置',
  'workspace_storyboard_config_required_title': '尚未生成分镜配置',
  'workspace_storyboard_config_required_hint': '点击下方「生成分镜配置」按钮，生成后再编辑镜头与分镜内容',
  'workspace_workflow_complete_eyebrow': 'Workflow Complete',
  'workspace_workflow_complete_title': '工作流已完成',
  'workspace_workflow_complete_desc': '从剧情导入到制作分镜，全部节点已顺利跑通。可以随时回看任一阶段内容。',
  'workspace_add_shot': '新增镜头',
  'workspace_add_shot_title': '新增镜头',
  'workspace_add_shot_index_label': '镜头序号',
  'workspace_add_shot_index_hint': '插入位置：0 表示开头，1 表示第一个分镜之后',
  'workspace_add_shot_duration_label': '镜头时长（秒）',
  'workspace_add_shot_duration_hint': '对应接口 duration_seconds，默认 8 秒',
  'workspace_add_shot_duration_invalid': '请输入有效的镜头时长（正整数秒）',
  'workspace_add_shot_text_label': '镜头文本',
  'workspace_add_shot_text_placeholder': '请输入镜头原文内容…',
  'workspace_add_shot_submit': '确认新增',
  'workspace_add_shot_success': '镜头已新增',
  'workspace_add_shot_pipeline_title': '正在新增镜头…',
  'workspace_add_shot_step_content': '处理镜头内容',
  'workspace_add_shot_step_content_hint': '正在解析镜头文本并写入场景，请稍候…',
  'workspace_add_shot_step_config': '生成分镜配置',
  'workspace_add_shot_step_config_hint': '镜头内容就绪，正在生成图/视频提示词…',
  'workspace_add_shot_pipeline_ready': '镜头已就绪',
  'workspace_add_shot_content_failed': '镜头内容处理失败: {{message}}',
  'workspace_add_shot_configuring': '配置生成中…',
  'workspace_add_shot_config_ready': '镜头配置已更新',
  'workspace_add_shot_config_failed': '镜头配置更新失败: {{message}}',
  'workspace_add_shot_failed': '新增镜头失败: {{message}}',
  'workspace_add_shot_index_invalid': '请输入有效的镜头序号（非负整数）',
  'workspace_add_shot_text_required': '请输入镜头文本',
  'workspace_add_episode': '添加剧集',
  'workspace_episode_list_title': '剧集列表',
  'workspace_add_episode_title': '添加剧集',
  'workspace_add_episode_index_label': '剧集序号',
  'workspace_add_episode_index_hint': '插入位置（从 1 开始）',
  'workspace_add_episode_content_label': '剧集内容',
  'workspace_add_episode_mode_label': '内容方式',
  'workspace_add_episode_mode_text': '纯文本资源',
  'workspace_add_episode_mode_file': '上传文件资源',
  'workspace_add_episode_text_placeholder': '请输入剧集文本内容…',
  'workspace_add_episode_text_required': '请输入剧集文本',
  'workspace_add_episode_file_label': '剧集文件',
  'workspace_add_episode_file_hint': '上传剧集文本文件，确认后会先上传再插入剧集',
  'workspace_add_episode_file_placeholder': '点击或拖拽文件到此处',
  'workspace_add_episode_file_selected': '已选择：{{name}}',
  'workspace_add_episode_submit': '确认添加',
  'workspace_add_episode_success': '剧集已添加',
  'workspace_add_episode_processing': '正在处理剧集…',
  'workspace_add_episode_processing_hint': '新增剧集内容生成中，完成后将自动刷新',
  'workspace_add_episode_pipeline_title': '正在准备新剧集…',
  'workspace_add_episode_step_script': '处理剧集内容',
  'workspace_add_episode_step_script_hint': '正在解析并写入本集剧本，请稍候…',
  'workspace_add_episode_step_config': '生成分镜配置',
  'workspace_add_episode_step_config_hint': '剧本就绪，正在生成本集图/视频提示词…',
  'workspace_add_episode_ready': '新剧集已就绪',
  'workspace_add_episode_failed': '添加剧集失败: {{message}}',
  'workspace_add_episode_process_failed': '剧集处理失败: {{message}}',
  'workspace_add_episode_index_invalid': '请输入有效的剧集序号（正整数）',
  'workspace_add_episode_file_required': '请上传剧集文件',
  'workspace_delete_episode': '删除剧集',
  'workspace_delete_episode_confirm_title': '确认删除剧集',
  'workspace_delete_episode_confirm_desc': '确定删除「{{name}}」？删除后不可恢复，后续剧集序号将自动调整。',
  'workspace_delete_episode_confirm': '确认删除',
  'workspace_delete_episode_success': '剧集已删除',
  'workspace_delete_episode_failed': '删除剧集失败: {{message}}',
  'workspace_delete_shot': '删除镜头',
  'workspace_delete_shot_confirm_title': '确认删除镜头',
  'workspace_delete_shot_confirm_desc': '确定删除镜头「{{id}}」？删除后不可恢复。',
  'workspace_delete_shot_confirm': '确认删除',
  'workspace_delete_shot_success': '镜头已删除',
  'workspace_delete_shot_failed': '删除镜头失败: {{message}}',
  'workspace_regenerate_storyboard': '重新生成分镜',
  'workspace_regenerate_storyboard_confirm_title': '重新生成分镜',
  'workspace_regenerate_storyboard_confirm_desc': '将重新生成本集分镜配置，现有分镜内容可能会被覆盖。确定继续？',
  'workspace_generating_storyboards': '分镜生成中...',
  'workspace_storyboards_queued': '分镜任务已入队',
  'workspace_storyboards_ready_toast': '分镜配置生成完成',
  'workspace_storyboards_failed': '分镜生成失败: {{message}}',
  'workspace_storyboards_generating_hint': '正在为各集生成分镜提示词与视频配置，请稍候…',
  'workspace_storyboard_episode_generating_hint': '正在生成本集分镜配置，请稍候…',
  'workspace_storyboard_config_loading': '加载分镜中…',
  'workspace_storyboard_config_loading_hint': '正在获取本集分镜详情，请稍候…',
  'workspace_generating_script': '生成中...',
  'workspace_script_queued': '排队中...',
  'workspace_script_queued_hint': '剧本生成任务已入队，请耐心等待，完成后将自动刷新分集列表',
  'workspace_script_fetching': '获取数据中...',
  'workspace_script_fetching_hint': '正在加载分集列表，请稍候…',
  'workspace_script_ready_toast': '剧本生成完成',
  'workspace_asset_extract_queued': '资产提取任务已入队，完成后将自动刷新',
  'workspace_asset_extract_reused_task': '未能新建「{{label}}」提取任务：服务端返回了已有任务，未单独入队',
  'workspace_asset_extract_ready_toast': '资产提取完成',
  'workspace_asset_extract_failed': '资产提取失败: {{message}}',
  'workspace_asset_extract_failed_fallback': '未知错误',
  'workspace_script_episodes_empty_title': '暂无分集',
  'workspace_script_episodes_empty_hint': '点击上方「生成剧本」开始创建分集',
  'workspace_script_content_label': '剧本内容',
  'workspace_script_process_failed': '生成剧本失败: {{message}}',
  'workspace_no_source_for_script': '未找到小说源文件，请先上传源文件',
  'workspace_empty_source_for_script': '源文件内容为空，请重新上传',
  'workspace_script_empty_result': '未获取到剧本内容',
  'workspace_script_episodes_label': '剧本分集',
  'workspace_script_episode_name_column': '集名称',
  'workspace_script_episode_characters_column': '人物',
  'workspace_script_episode_content_column': '内容',
  'workspace_script_episode_created_at_column': '创建时间',
  'workspace_script_episode_status_column': '状态',
  'workspace_script_episode_updated_at_column': '更新时间',
  'workspace_script_episode_total_scenes_column': '场景数',
  'workspace_script_episode_duration_column': '预估时长',
  'workspace_script_episode_status_draft': '草稿',
  'workspace_script_episode_detail_title': '{{name}} · 场景详情',
  'workspace_script_episode_scene_count': '共 {{count}} 个场景',
  'workspace_script_episode_empty_preview': '暂无内容',
  'workspace_script_scene_visual': '画面',
  'workspace_script_scene_action': '动作',
  'workspace_script_scene_narration': '旁白',
  'workspace_script_scene_dialogue': '对白',
