...
interface SceneInlineCardProps {
  name: string;
  scene: Scene;
  projectName: string;
...
export function SceneInlineCard({
  name,
  scene,
  projectName,
  onUpdate,
  ...
  return (
    <div
      id={`scene-${name}`}
      className="relative flex h-[520px] flex-col overflow-hidden rounded-xl p-5"
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col">
        ...
        <textarea
          ...
          className="focus-ring mt-1.5 min-h-0 flex-1 resize-none overflow-y-auto rounded-lg px-3 py-2 text-[13px] leading-[1.55] outline-none transition-[border-color,box-shadow]"
          style={FIELD_STYLE}
      ...
      <div className="mt-3 shrink-0 space-y-2">
        {isDirty && (
          <button
            type="button"
            onClick={handleSave}
            className="focus-ring inline-flex w-full items-center justify-center gap-1.5 rounded-md px-3 py-1.5 text-[12px] font-medium transition-transform"
            style={{
