...
import { getToastTopClass } from "@/utils/toast-layout";
...
export function ToastOverlay() {
  ...
  const topClass = getToastTopClass(pathname);
  ...
  return (
    <div
      className={`fixed ${topClass} left-1/2 -translate-x-1/2 ${UI_LAYERS.toast} pointer-events-none`}
    >
      <div
        key={toast.id}
