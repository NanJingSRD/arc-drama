...
import { W3, W3_AVATAR_STYLE } from "@/components/workspace";
...
export function ProjectMenu() {
  ...
  return (
    <div ref={ref} className="relative min-w-0">
      ...
      >
        <div
          className="grid h-6 w-6 shrink-0 place-items-center rounded-[6px] text-[11.5px] font-bold display-serif"
          style={W3_AVATAR_STYLE}
        >
          {initial}
        </div>
      ...
      {open && (
        ...
        >
          ...
          >
            <div
              className="display-serif grid h-[30px] w-[30px] shrink-0 place-items-center rounded-[6px] text-sm font-bold"
              style={W3_AVATAR_STYLE}
            >
              {initial}
            </div>
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5">
                <span className="text-[13px] font-semibold" style={{ color: W3.cyan }}>
                  {projectTitle}
                </span>
                <span
          ...
          <button
            ...
            onClick={() => {
              setOpen(false);
              setLocation(absoluteAppPath("/app/projects"));
            }}
