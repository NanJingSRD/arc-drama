...
describe("GlassModal", () => {
  ...
  it("lets widthClassName override ModalShell default max-w-[96vw]", () => {
    render(
      <GlassModal open onClose={() => {}} ariaLabel="x" widthClassName="w-full max-w-2xl">
        <p>body</p>
      </GlassModal>,
    );
    const dialog = screen.getByRole("dialog");
    expect(dialog.className).toContain("max-w-2xl");
    expect(dialog.className).not.toContain("max-w-[96vw]");
  });
